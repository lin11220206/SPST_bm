...
a.out: main.o header.o structure.o function.o result.o clock.o
	${CC} main.o header.o structure.o function.o result.o clock.o ${CFLAGS} ${INC} -o a.out
main.o: main.c ${INC_PATH}/header.h ${INC_PATH}/structure.h ${INC_PATH}/function.h ${INC_PATH}/result.h ${INC_PATH}/clock.h
